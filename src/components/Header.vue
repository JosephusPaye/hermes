<template>
  <div class="px-5 pt-5 flex">
    <div
      class="text-xl bg-black text-white leading-none px-5 py-2 rounded-full"
    >
      Limbo
    </div>
    <!-- <button
      class="border-l border-gray-200 bg-black text-white rounded-full rounded-l-none pr-3 pl-2"
    >
      <svg
        version="1.1"
