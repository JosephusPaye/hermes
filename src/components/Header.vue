<template>
  <div class="px-5 pt-5 flex items-center w-full">
    <div
      class="text-xl bg-black text-white cursor-default select-none leading-none pl-5 pr-3 h-9 flex items-center rounded-full rounded-r-none"
    ...
    <div class="text-gray-500 text-sm ml-auto flex pr-1">
      <div>
        By
        <a
